...
15 1 * * 4 /opt/docker-compose/hookstack/hookprobe/examples/patrols/patrol.sh /opt/docker-compose/hookstack/patrols/ai-rulings.md "Patrol: AI rulings" >> /var/log/hookstack-patrol.log 2>&1
